...
const Sidebar: FC<SidebarProps> = ({
  ...
  return (
    <div className=" bg-black/40 backdrop-blur-3xl rounded-l-2.5 flex flex-col w-[200px]">
      <div className="h-13 w-full px-5 py-[9px] flex items-center">
        <div className="flex gap-2">
          <span className="w-3 h-3 rounded-full bg-sunsetOrange border border-red-500 cursor-pointer"></span>
      ...
      {enableSeparator && <span className="border-b border-solid border-neutral-500/50" />}
